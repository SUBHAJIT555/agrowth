...
export const goodInTheWoods: CaseStudyDetail = {
  slug: "good-in-the-woods",
  ...
  challenge: (
    <>
      <p>
        <strong>Good in the Woods</strong> struggled to optimize ad spend and couldn&apos;t effectively identify our target audience. Their campaigns were expensive but yielded low conversion rates. In addition, tracking and analyzing campaign performance was confusing and time-consuming. <strong>Their online presence needed to scale</strong>.
      </p>
      <CsImage
        src="/assets/images/case-studies/good-in-the-woods/woods-challenge.jpg"
        alt=""
        width={1366}
        height={1110}
      />
  ...
  solution: (
    <>
      ...
      <ul>
        ...
        <li>24/7 onboarding &amp; live support, so their team was never left guessing</li>
        <li>Performance monitoring &amp; feedback, optimizing bidding strategies, and creative testing.</li>
      </ul>
      <CsImage
        src="/assets/images/case-studies/good-in-the-woods/woods-meta-billing.png"
        alt=""
        width={997}
        height={471}
        align="center"
  ...
  results: (
    <>
      <p>
        The improvement after <strong>30 days</strong> wasn’t just noticeable - it was backed by strong data.
      </p>
      <p>In April 2025 alone, Good in the Woods recorded:</p>
      <CsImage
        src="/assets/images/case-studies/good-in-the-woods/woods-results.png"
        alt=""
        width={1186}
        height={237}
      />
      ...
      <ul>
        ...
        <li>
          <strong>Target Market</strong>: U.S. and international eco-conscious shoppers
        </li>
        <li>
          <strong>Main Objective</strong>: Scale Meta ad campaigns with stability and higher daily budgets
        </li>
      </ul>
      <h2>
      ...
      <p>The partnership succeeded because it combined the right infrastructure with the right support:</p>
      <ul>
        <li>Technical flexibility through agency-level accounts</li>
        <li>Operational confidence from 1-on-1 support</li>
        <li>Performance insights to help scale what worked, faster</li>
