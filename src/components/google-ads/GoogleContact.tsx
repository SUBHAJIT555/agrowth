...
import { ArrowUpRightIcon, CalendarIcon, ChatIcon } from "@/components/google-ads/icons";
...
export function GoogleContact() {
  ...
  return (
    <section
      ...
      className="google-contact home-contact faq-contact contact-page sp2"
    >
