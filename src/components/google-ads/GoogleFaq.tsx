...
import { CaretDownIcon } from "@/components/google-ads/icons";
...
export function GoogleFaq() {
  const [openIndex, setOpenIndex] = useState<number | null>(null);

  return (
    <section className="service-faqs sp" style={{ backgroundColor: "#fff2e6" }} aria-labelledby="google-faq-heading">
      <div className="container">
        <div className="heading5 text-center" style={{ textAlign: "center" }}>
          <h2 id="google-faq-heading">
