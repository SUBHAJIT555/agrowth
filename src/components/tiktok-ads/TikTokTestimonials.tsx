...
import { ArrowRightIcon } from "@/components/tiktok-ads/icons";
...
export function TikTokTestimonials() {
  ...
  return (
    <section className="customer-reviews-section" style={{ backgroundColor: "#fff2e6" }} aria-labelledby="tiktok-reviews-heading">
      <div className="container">
        <div className="heading5" style={{ textAlign: "center" }}>
          <h2 id="tiktok-reviews-heading">
