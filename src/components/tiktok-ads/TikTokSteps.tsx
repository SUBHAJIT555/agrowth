...
const steps = [
  {
    ...
    desc: "Quick fit check, pricing, and straight answers from a TikTok specialist",
  },
  {
    number: "2",
...
export function TikTokSteps() {
  return (
    <section className="tiktok-steps" aria-labelledby="tiktok-steps-heading">
      <div className="container">
        <FadeIn>
          <div className="section-header">
            <h2 id="tiktok-steps-heading">
              Get your
              <span>TikTok Agency Ad Accounts in 4 steps</span>
            </h2>
          </div>
        </FadeIn>
