...
export function HomeContact() {
  ...
  return (
    <section id="home-contact" className="home-contact faq-contact contact-page sp2">
          ...
          <div className="col-lg-6">
            <div className="heading5">
              ...
              <div className="content-contact">
                <p>
                  Grow your ads with our trusted agency accounts — activated fast, billed flexibly, and backed by 24/7 expert support.
                </p>
                <p>
